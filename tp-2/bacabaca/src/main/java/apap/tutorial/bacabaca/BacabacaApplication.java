...
public static void main(String[] args) { SpringApplication.run(BacabacaApplication.class, args); }
...
// Membuat fake data memanfaatkan Java Faker
    ...
    // Mapping penerbitbto ke buku lalu save penerbit ke database
    ...
    // Mapping bukuDTo ke buku laly save buku ke database
